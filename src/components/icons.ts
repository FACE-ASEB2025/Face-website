/**
 * Icon path data (Lucide-derived, ISC licensed).
 *
 * Kept in a .ts module rather than inside Icon.astro so the name union can be
 * imported anywhere — data files that pick an icon, components that pass one
 * through — without importing the component itself.
 *
 * Every glyph is drawn in a 24×24 box with a 1.75 stroke so they sit
 * consistently beside text at any size.
 */
